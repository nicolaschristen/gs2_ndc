...
module collisions
  ...
  public :: timesteps_between_collisions
...
! following only needed for adaptive collisionality
    ...
    if (proc0) then
       ...
       timesteps_between_collisions = 1
...
!<
    call broadcast (timesteps_between_collisions)
    ...
    call broadcast (split_collisions)
