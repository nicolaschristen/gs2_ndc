...
!This allows the removal of the select case statements in the index routines
    ...
    !AJ If the number of naky*ntheta0 points is less than the number of 1
...
!</DD>
  ...
  ! to create unbalanced xxf and yxf layouts to address 1
  ...
  ! space to real space and back again.
  !
  ! Input iproc is this processes 1 id.
  !
